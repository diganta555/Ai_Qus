...
export default function Subjects() {
  ...
  return (
    <div>
      ...
      <p className="text-gray-500 mb-6 text-sm sm:text-base">Create a new subject and manage your existing subjects.</p>
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-4 sm:p-5 mb-6">
        ...
        <form onSubmit={create} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="col-span-1 sm:col-span-2 lg:col-span-4 flex justify-end">
            <button
              type="submit"
              className="w-full sm:w-auto bg-primary text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-primaryDark"
            >
              + Create Subject
            </button>
          </div>
