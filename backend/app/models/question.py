...
class ExtractedQuestion(Base):
    ...
    repetition_type = Column(String, nullable=True)     # "exact" | "near" | "concept" | None
    repetition_group_id = Column(Integer, nullable=True)  # links questions that repeat each other
